...
export const SPECIAL_ROLES: readonly SpecialRoleDef[] = [
  ...
  },
  {
    ...
    name: 'Les Duellistes',
    icon: 'swords',
    tagline: 'Deux adversaires secrets : seul celui qui élimine l’autre par son vote gagne.',
    power: 'Deux joueurs s’affrontent en secret et connaissent l’identité de leur adversaire.',
    objective: 'Éliminer son adversaire par son vote. Cet objectif remplace celui de leur camp de départ.',
    victory:
      'Un Duelliste gagne seul s’il vote contre son adversaire lors du scrutin qui l’élimine (second scrutin compris). Sa victoire est annoncée à tous, sans mettre fin à la manche. Il ne gagne jamais avec son camp, même si celui-ci l’emporte.',
    restrictions: [
      '5 joueurs minimum.',
      'Le duel s’arrête à la première chute : si l’adversaire tombe autrement (décision de la Justice, Vengeuse, lien des Amoureux, scrutin sans son vote), personne ne gagne le duel.',
    ],
    minPlayers: 5,
    slots: 2,
  },
